...
version "2.1.3" "2.1.4" "2.1.5" "2.2.2" {
  auto-version {
...
sha256sums = {
  ...
  "https://github.com/estesp/manifest-tool/releases/download/v2.2.2/binaries-manifest-tool-2.2.2.tar.gz": "bdca525326694849594ab3ba63638fdb664690c9384df947bd3cff943d14736b",
}
